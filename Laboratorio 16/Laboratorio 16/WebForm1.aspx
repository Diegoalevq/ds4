...
<head id="Head1" runat="server">
    ...
    <body>
        <form id="form1" runat="server">
            <div class="cal">
                <asp:Label ID="l" Text=" CALCULADORA BASICA" runat="server" Style="margin-left: 50px" Font-Bold="true" Font-Italic="false" ForeColor="White" Font-Size="25px"></asp:Label>
                ...
                <asp:Button ID="add" Text="+" runat="server" Height="37px" Style="margin-left: 0px; margin-top: 0px;" Width="57px" OnClick="add_Click" />
